...
class UserController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        // Use authLogs as a proxy for activity for now, or empty collection if strictly sticking to requested changes
        $activityLogs = $user->authLogs()->latest()->take(10)->get();
        ...
        return view('pages.admin.users.show', compact('user', 'stats', 'recentOrders', 'activityLogs'));
    }
