<div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
    ...
    <nav class="flex-1 p-4 space-y-1 bg-gray-50/50">
        ...
        <a href="{{ route('tickets.index') }}"
           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200
           {{ request()->routeIs('tickets.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 {{ request()->routeIs('tickets.*') ? 'text-orange-500' : 'text-gray-400' }}"
                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
