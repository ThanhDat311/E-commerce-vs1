            ...
            <div class="relative z-10 flex flex-col justify-between p-12 text-white w-full">
                ...
                <div class="space-y-6">
                    <h1 class="text-5xl font-bold leading-tight">
                        Unified Commerce<br/>Reimagined.
                    </h1>
                    <p class="text-lg text-slate-300 max-w-md">
                        Experience the seamless integration of vendors, staff, and customers in one secure ecosystem.
                    </p>
                    
                    <!-- Trust Indicators -->
                    <div class="flex items-center space-x-4 pt-8">
                        <div class="flex -space-x-2">
                            <img class="w-10 h-10 rounded-full border-2 border-slate-800" src="https://ui-avatars.com/api/?name=User+1&background=6366f1" alt="">
                            <img class="w-10 h-10 rounded-full border-2 border-slate-800" src="https://ui-avatars.com/api/?name=User+2&background=8b5cf6" alt="">
                            <img class="w-10 h-10 rounded-full border-2 border-slate-800" src="https://ui-avatars.com/api/?name=User+3&background=ec4899" alt="">
                            <div class="w-10 h-10 rounded-full border-2 border-slate-800 bg-slate-700 flex items-center justify-center text-xs">+99</div>
                        </div>
                        <span class="text-sm text-slate-400">Trusted by leading retailers</span>
                    </div>
                </div>
            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <p class="text-center text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-500 font-medium">Register now</a>
                    </p>
                </form>
            </div>
        </div>
