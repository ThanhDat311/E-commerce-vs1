...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body p-4">
            <form action="{{ route('vendor.products.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img id="imagePreview" src="https://via.placeholder.com/300" alt="Preview" style="width: 100%; border-radius: 8px; border: 1px solid #dee2e6;">
                            </div>
