<x-vendor-layout :page-title="'Edit Product'" :breadcrumbs="['Vendor' => route('vendor.dashboard'), 'Products' => route('vendor.products.index'), 'Edit' => '#']">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="discount_price" class="block mt-1 w-full" type="number" name="discount_price" :value="old('discount_price', $product->discount_price)" step="0.01" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="quantity" class="block mt-1 w-full" type="number" name="quantity" :value="old('quantity', $product->stock_quantity)" required />
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="mt-6 space-y-3 bg-gray-50 p-4 rounded-lg">
                                    <div class="flex items-center">
                                        <input id="is_new" type="checkbox" name="is_new" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('is_new', $product->is_new) ? 'checked' : '' }}>
                                        <label for="is_new" class="ml-2 block text-sm text-gray-900">Mark as New Arrival</label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="is_featured" type="checkbox" name="is_featured" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('is_featured', $product->is_featured) ? 'checked' : '' }}>
